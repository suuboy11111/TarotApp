...
namespace TarotApp
{
    public partial class frmTinhYeu : Form
    {
        ...
        private void frmTinhYeu_Load(object sender, EventArgs e)
        {
        ...
        private void SaveReadingHistory()
        {
            ...
            {
                // Tìm chủ đề "Tình Yêu"
                var theme = db.Themes.FirstOrDefault(t => t.ThemeName == "Tình Yêu");
        ...
        private void frmTinhYeu_FormClosed(object sender, FormClosedEventArgs e)
        {
