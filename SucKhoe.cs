...
namespace TarotApp
{
    public partial class frmSucKhoe : Form
    {
        ...
        private void SaveReadingHistory()
        {
            ...
            {
                // Tìm chủ đề "Tình Yêu"
                var theme = db.Themes.FirstOrDefault(t => t.ThemeName == "Sức Khỏe");
        ...
        private void frmSucKhoe_FormClosed(object sender, FormClosedEventArgs e)
        {
